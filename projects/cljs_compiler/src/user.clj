...
;; - Start with :1.13-storm and :fs-cljs-compiler-plugin aliases/profiles
...
;;    - clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version "1.7.0"}}}' -M -m nrepl.cmdline --connect --host localhost --port `cat .nrepl-port`
...
;; Other options for running the repl
;; (cljs.main/-main "--repl" "-ro" "{:launch-browser false}")
;; (cljs.main/-main "-ro" "{:launch-browser false}" "--repl")
